...
exports.pushPR = void 0;
var octokit_1 = require("octokit");
var common_1 = require("../../common");
var pushPR = function (actionInputs, maintainer, repoName, prNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var sliceOctokit, projectManangerView, isMaintainer, projectId, _a, linkedIssues, prId, _b, issueId, issueNumber, issueOSSData, itemId, projectAllFields, currentStatus, statusField, statusClientReviewOption;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                common_1.logger.logInputs('open-source push-pr ', { repoName: repoName, prNumber: prNumber, maintainer: maintainer });
            ...
            case 12:
                ...
                statusClientReviewOption = (_c = statusField.options) === null || _c === void 0 ? void 0 : _c.find(function (x) { return x.name === common_1.OPEN_SOURCE_STATUS_OPTIONS.ClientReview; });
                if (!(currentStatus !== common_1.OPEN_SOURCE_STATUS_OPTIONS.ReadyToPushUpstream)) return [3 /*break*/, 14];
                return [4 /*yield*/, common_1.error.throwWithGithubComment(sliceOctokit, prId, "Issue status has to be `" + common_1.OPEN_SOURCE_STATUS_OPTIONS.ReadyToPushUpstream + "` to execute this job")];
            case 13:
                _d.sent();
                _d.label = 14;
            case 14:
                common_1.logger.logWriteLine('OpenSource', "Updating 'Status=Client review'...");
                return [4 /*yield*/, (0, common_1.updateIssueFieldValue)(sliceOctokit, projectId, itemId, statusField.id, 'SingleSelect', statusClientReviewOption === null || statusClientReviewOption === void 0 ? void 0 : statusClientReviewOption.id)];
            case 15:
                _d.sent();
...
exports.pushPR = pushPR;
//# sourceMappingURL=push-pr.js.map