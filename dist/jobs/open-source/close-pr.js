...
exports.closePR = void 0;
var octokit_1 = require("octokit");
var common_1 = require("../../common");
var closePR = function (actionInputs, maintainer, repoName, prNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var sliceOctokit, projectManangerView, isMaintainer, projectId, _a, linkedIssues, prId, _b, issueId, issueNumber, issueOSSData, itemId, projectAllFields, currentStatus, statusField, statusPRClosedOption, requiredStatus;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                common_1.logger.logInputs('open-source close-pr', { repoName: repoName, prNumber: prNumber, maintainer: maintainer });
            ...
            case 12:
                ...
                statusPRClosedOption = (_c = statusField.options) === null || _c === void 0 ? void 0 : _c.find(function (x) { return x.name === common_1.OPEN_SOURCE_STATUS_OPTIONS.PRClosed; });
                requiredStatus = [
                    common_1.OPEN_SOURCE_STATUS_OPTIONS.InProgress,
                    common_1.OPEN_SOURCE_STATUS_OPTIONS.ChangesRequested,
                    common_1.OPEN_SOURCE_STATUS_OPTIONS.ClientReview,
                    common_1.OPEN_SOURCE_STATUS_OPTIONS.ReadyForLastReview,
                    common_1.OPEN_SOURCE_STATUS_OPTIONS.ReadyToPushUpstream,
                ];
                if (!!requiredStatus.includes(currentStatus)) return [3 /*break*/, 14];
                return [4 /*yield*/, common_1.error.throwWithGithubComment(sliceOctokit, prId, "Issue status has to be `" + requiredStatus.join('` `') + "` to execute this job")];
            case 13:
                _d.sent();
                _d.label = 14;
            case 14:
                common_1.logger.logWriteLine('OpenSource', "Updating 'Status=PR closed'...");
                return [4 /*yield*/, (0, common_1.updateIssueFieldValue)(sliceOctokit, projectId, itemId, statusField.id, 'SingleSelect', statusPRClosedOption === null || statusPRClosedOption === void 0 ? void 0 : statusPRClosedOption.id)];
            case 15:
                _d.sent();
                common_1.logger.logExtendLastLine("Done!");
                common_1.logger.logWriteLine('OpenSource', "Leaving comments...");
                return [4 /*yield*/, (0, common_1.addComment)(sliceOctokit, prId, common_1.OPEN_SOURCE_COMMENT_PR_DISCONTINUED)];
            case 16:
                _d.sent();
                return [4 /*yield*/, (0, common_1.addComment)(sliceOctokit, issueId, common_1.OPEN_SOURCE_COMMENT_ISSUE_DISCONTINUED)];
            case 17:
                _d.sent();
                common_1.logger.logExtendLastLine("Done!");
...
//# sourceMappingURL=close-pr.js.map