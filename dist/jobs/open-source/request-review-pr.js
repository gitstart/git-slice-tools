...
exports.requestReviewPR = void 0;
var octokit_1 = require("octokit");
var common_1 = require("../../common");
var requestReviewPR = function (actionInputs, maintainer, repoName, prNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var sliceOctokit, projectManangerView, isMaintainer, projectId, _a, linkedIssues, prId, _b, issueId, issueNumber, issueOSSData, itemId, projectAllFields, currentStatus, statusField, statusReadyForLastReviewOption, requiredStatus;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                common_1.logger.logInputs('open-source request-review-pr ', { repoName: repoName, prNumber: prNumber, maintainer: maintainer });
            ...
            case 12:
                ...
                statusReadyForLastReviewOption = (_c = statusField.options) === null || _c === void 0 ? void 0 : _c.find(function (x) { return x.name === common_1.OPEN_SOURCE_STATUS_OPTIONS.ReadyForLastReview; });
                requiredStatus = [
            ...
            case 13:
                ...
                _d.label = 14;
            case 14:
                common_1.logger.logWriteLine('OpenSource', "Updating 'Status=Ready for last review'...");
                return [4 /*yield*/, (0, common_1.updateIssueFieldValue)(sliceOctokit, projectId, itemId, statusField.id, 'SingleSelect', statusReadyForLastReviewOption === null || statusReadyForLastReviewOption === void 0 ? void 0 : statusReadyForLastReviewOption.id)];
            case 15:
                _d.sent();
...
exports.requestReviewPR = requestReviewPR;
//# sourceMappingURL=request-review-pr.js.map