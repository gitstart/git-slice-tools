...
exports.updateEstimate = void 0;
var octokit_1 = require("octokit");
var common_1 = require("../../common");
var updateEstimate = function (actionInputs, repoName, issueNumber, credits) { return __awaiter(void 0, void 0, void 0, function () {
    var sliceOctokit, projectManangerView, projectId, issueId, issueOSSData, itemId, projectAllFields, estimateField;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                common_1.logger.logInputs('open-source update-estimate', { repoName: repoName, issueNumber: issueNumber, credits: credits });
            ...
            case 6:
                projectAllFields = _a.sent();
                estimateField = projectAllFields.find(function (x) { return x.name === common_1.OPEN_SOURCE_FIELDS.CreditEstimate; });
                common_1.logger.logWriteLine('OpenSource', "Updating 'Credit estimate=<credits>'...");
                return [4 /*yield*/, (0, common_1.updateIssueFieldValue)(sliceOctokit, projectId, itemId, estimateField.id, 'Number', credits)];
            case 7:
                _a.sent();
...
//# sourceMappingURL=update-esimate.js.map