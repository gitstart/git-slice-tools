...
exports.reviewerApproveIssue = void 0;
var octokit_1 = require("octokit");
var common_1 = require("../../common");
var reviewerApproveIssue = function (actionInputs, reviewer, repoName, issueNumber) { return __awaiter(void 0, void 0, void 0, function () {
    var sliceOctokit, projectManangerView, hasRightPermission, projectId, _a, issueId, issueAddedBy, issueOSSData, itemId, projectAllFields, currentStatus, statusField, issueReviewerField, statusIssueApprovedOption;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                common_1.logger.logInputs('open-source reviewer-approve-issue', { reviewer: reviewer, repoName: repoName, issueNumber: issueNumber });
            ...
            case 10:
                ...
                statusIssueApprovedOption = (_b = statusField.options) === null || _b === void 0 ? void 0 : _b.find(function (x) { return x.name === common_1.OPEN_SOURCE_STATUS_OPTIONS.IssueApproved; });
            ...
            case 11:
                ...
                _c.label = 12;
            case 12:
                common_1.logger.logWriteLine('OpenSource', "Updating 'Status=<Issue approved>'...");
                return [4 /*yield*/, (0, common_1.updateIssueFieldValue)(sliceOctokit, projectId, itemId, statusField.id, 'SingleSelect', statusIssueApprovedOption === null || statusIssueApprovedOption === void 0 ? void 0 : statusIssueApprovedOption.id)];
            case 13:
                _c.sent();
...
exports.reviewerApproveIssue = reviewerApproveIssue;
//# sourceMappingURL=reviewer-approve-issue.js.map