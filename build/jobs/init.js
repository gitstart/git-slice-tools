...
var init = function (actionInputs) { return __awaiter(void 0, void 0, void 0, function () {
    var upstreamGit, sliceGit, upstreamRemote, upstreamUser, sliceRemote, sliceUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                upstreamGit = (0, simple_git_1.default)(actionInputs.upstreamRepoDir, { binary: 'git' });
                sliceGit = (0, simple_git_1.default)(actionInputs.sliceRepoDir, { binary: 'git' });
                (0, terminal_kit_1.terminal)('Upstream: Feching...');
                return [4 /*yield*/, upstreamGit.fetch('origin')];
            case 1:
                _a.sent();
            ...
            case 2:
                ...
                return [4 /*yield*/, upstreamGit.getConfig('user.name')];
            case 3:
                upstreamUser = _a.sent();
                (0, terminal_kit_1.terminal)("Upstream: User: " + upstreamUser.value + "\n");
                (0, terminal_kit_1.terminal)('Slice: Fetching...');
                return [4 /*yield*/, sliceGit.fetch('origin')];
            case 4:
                _a.sent();
                (0, terminal_kit_1.terminal)('Done!\n');
            ...
            case 5:
                ...
                return [4 /*yield*/, sliceGit.getConfig('user.name')];
            case 6:
                sliceUser = _a.sent();
                (0, terminal_kit_1.terminal)("Slice: User: " + sliceUser.value + "\n");
                return [2 /*return*/, {
                        sliceGit: sliceGit,
